document.addEventListener("DOMContentLoaded", function () {
    ...
    class FormSteps {
        constructor(form) {
            ...
            this.$mobile = this.$form.querySelector('input.mobile');
        ...
        generalValidation() {
            ...
            function createAlert(step, errorInfo) {
                ...
                errorDiv.classList.add("btn--small");
                errorDiv.classList.add("span.error");
                // errorDiv.setAttribute("value", "alert");
        ...
        updateForm() {
            ...
            this.$form.querySelector('div[data-step="5"] .summary li.quantityProceed').innerText = getBagsInf(this.$bagQuantity.value);
            this.$form.querySelector('div[data-step="5"] .summary li.institutionProceed').innerText = getInstitutionsInf(this.$radiobuttons);
            this.$form.querySelector('div[data-step="5"] .summary li.streetProceed').innerText = this.$street.value;
            this.$form.querySelector('div[data-step="5"] .summary li.cityProceed').innerText = this.$city.value;
            this.$form.querySelector('div[data-step="5"] .summary li.zipCodeProceed').innerText = this.$zipCode.value;
            this.$form.querySelector('div[data-step="5"] .summary li.mobileProceed').innerText = getMobileInf(this.$mobile.value);
            this.$form.querySelector('div[data-step="5"] .summary li.dateProceed').innerText = this.$date.value;
            this.$form.querySelector('div[data-step="5"] .summary li.timeProceed').innerText = this.$time.value;
            this.$form.querySelector('div[data-step="5"] .summary li.commentProceed').innerText = getCommentInf(this.$comment.value);
            ...
            function getMobileInf(mobile) {
                if (mobile.length == 9)
                    return mobile.substr(0, 3) + ' ' + mobile.substr(4, 3) + ' ' + mobile.substr(7, 3)
                else
                    return mobile;
            }
