...
!function (a) {
    ...
    var e = {};
    e.common = {}, e.common.minChar = 6, e.common.usernameField = "#email", e.common.userInputs = [], e.common.onLoad = void 0, e.common.onKeyUp = void 0, e.common.zxcvbn = !1, e.common.zxcvbnTerms = [], e.common.debug = !1, e.rules = {}, e.rules.extra = {}, e.rules.scores = {
        wordNotEmail: -100,
        wordLength: -50,
    ...
    }, e.ui.verdicts = ["Słabe", "Zwykłe", "Średnie", "Silne", "Bardzo silne"], e.ui.showVerdicts = !0, e.ui.showVerdictsInsideProgressBar = !1, e.ui.useVerdictCssClass = !1, e.ui.showErrors = !1, e.ui.container = void 0, e.ui.viewports = {
        progress: void 0,
        verdict: void 0,
        errors: void 0
